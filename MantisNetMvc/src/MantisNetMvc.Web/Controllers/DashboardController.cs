...
using MantisNetMvc.Web.ViewModels.Dashboard;
...
public class DashboardController : Controller
{
    ...
    public async Task<IActionResult> Index([FromQuery] MyViewBoxSettings? settings = null)
    {
        ...
        if (Request.Cookies.TryGetValue("mantis_my_view_boxes", out var cookieValue) && settings == null)
        {
    ...
    public IActionResult SaveBoxSettings(MyViewBoxSettings settings)
    {
        ...
        Response.Cookies.Append("mantis_my_view_boxes", string.Join(",", activeBoxes), new CookieOptions
        {
