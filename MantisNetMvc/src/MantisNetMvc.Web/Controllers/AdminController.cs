...
[Authorize]
[MantisAuthorize(AccessLevel.Administrator, globalOnly: true)]
public class AdminController : Controller
{
    private readonly MantisDbContext _context;
    private readonly UserManager<ApplicationUser> _userManager;

    public AdminController(MantisDbContext context, UserManager<ApplicationUser> userManager)
    {
        _context = context;
    ...
    /// <summary>
    /// MantisBT Administration Portal & System Management Overview.
    /// </summary>
    [HttpGet]
