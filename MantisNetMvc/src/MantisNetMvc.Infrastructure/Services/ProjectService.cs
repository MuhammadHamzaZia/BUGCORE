...
namespace MantisNetMvc.Infrastructure.Services;
...
public class ProjectService : IProjectService
{
    ...
    public ProjectService(MantisDbContext context, IAccessControlService accessControl)
    {
        _context = context;
    ...
    public async Task<bool> AddSubprojectAsync(int parentProjectId, int childProjectId, bool inheritChild = false)
    {
        ...
        // Circular hierarchy prevention (matching MantisBT project_hierarchy_api.php)
